package com.hr.ms.ms_android.mvp.operation.activitymanager.detail
...
import kotlinx.android.synthetic.main.activitydetail_activity.*
import kotlinx.android.synthetic.main.toolbar_layout.*
import java.util.*

class ActivityDetailActivity : BaseActivity(), View.OnClickListener {
    ...
    private lateinit var adapter: ActivityGuestAdapter

    private var status :Int = -1

    override fun setViewId(): Int {
        return R.layout.activitydetail_activity
    }
    ...
    override fun initData() {
        ...
        adapter = ActivityGuestAdapter(recyclerView)
