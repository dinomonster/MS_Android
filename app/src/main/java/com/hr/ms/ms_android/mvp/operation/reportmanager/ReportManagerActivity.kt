package com.hr.ms.ms_android.mvp.operation.reportmanager
...
import com.hr.ms.ms_android.mvp.operation.reportmanager.detail.ReportDetailActivity
...
class ReportManagerActivity : BaseActivity(), SwipeRefreshLayout.OnRefreshListener{
    override fun getPresenter(): MvpPresenter? {        return null     }

    private lateinit var adapter: ReportManagerAdapter
    ...
    override fun initData() {
        ...
        adapter = ReportManagerAdapter(recyclerView)
        recyclerView.adapter = adapter
        adapter.setOnItemClickListener { adapter, view, position ->
            var intent = Intent(this, ReportDetailActivity::class.java)
