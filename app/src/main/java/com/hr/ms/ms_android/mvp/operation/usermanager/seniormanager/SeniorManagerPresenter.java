...
public class SeniorManagerPresenter extends BasePresenter implements SeniorManagerContract.Presenter {
    private final SeniorManagerContract.View mView;

    ServiceRepository repository;

    public SeniorManagerPresenter(SeniorManagerContract.View view,
                                  ServiceRepository repository) {
        mView = view;
