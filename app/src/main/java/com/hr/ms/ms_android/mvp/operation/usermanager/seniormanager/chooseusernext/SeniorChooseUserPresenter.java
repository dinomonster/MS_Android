...
public class SeniorChooseUserPresenter extends BasePresenter implements SeniorChooseUserContract.Presenter {
    private final SeniorChooseUserContract.View mView;

    ServiceRepository repository;

    public SeniorChooseUserPresenter(SeniorChooseUserContract.View view,
                                     ServiceRepository repository) {
        mView = view;
