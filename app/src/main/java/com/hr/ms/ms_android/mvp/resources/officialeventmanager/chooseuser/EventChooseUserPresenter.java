...
public class EventChooseUserPresenter extends BasePresenter implements StageChooseUserContract.Presenter {
    private final StageChooseUserContract.View mView;

    ServiceRepository repository;

    public EventChooseUserPresenter(StageChooseUserContract.View view,
                                    ServiceRepository repository) {
        mView = view;
