...
public class ChooseSeniorPresenter extends BasePresenter implements ChooseSeniorContract.Presenter {
    private final ChooseSeniorContract.View mView;

    ServiceRepository repository;

    public ChooseSeniorPresenter(ChooseSeniorContract.View view,
                                 ServiceRepository repository) {
        mView = view;
