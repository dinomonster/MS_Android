package com.hr.ms.ms_android.mvp.resources.schedulemanager.detail.guest.detail
...
import kotlinx.android.synthetic.main.guestedit_activity.*
import kotlinx.android.synthetic.main.toolbar_layout.*


class GuestDetailActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun setViewId(): Int {
        return R.layout.guestedit_activity
    }
    ...
    override fun initData() {
        ...
        //初始化监听
        ViewUtils.setOnClickListeners(this,teacher_iv,sharetime_ll,starttime_ll,endtime_ll)
    ...
    private fun initByStatus(){
        when(status){
            CommonConstants.STATUS_DETAIL->{//详情状态
                ViewUtils.setIsEnable(false,teacher_iv,sharetime_ll,starttime_ll,endtime_ll,sharetitle_et,sharedesc_et)
                ViewUtils.setIsVisibility(View.GONE,tv_save,sharetime_arrow,starttime_arrow,endtime_arrow)
                ViewUtils.setTextHint("输入",sharetitle_et,sharedesc_et)
            ...
            CommonConstants.STATUS_EDIT->{//编辑状态
                ViewUtils.setIsEnable(true,teacher_iv,sharetime_ll,starttime_ll,endtime_ll,sharetitle_et,sharedesc_et)
                ViewUtils.setIsVisibility(View.VISIBLE,tv_save,sharetime_arrow,starttime_arrow,endtime_arrow)
                ViewUtils.setTextHint("输入",sharetitle_et,sharedesc_et)
            ...
            CommonConstants.STATUS_ADD->{//新增状态
                ViewUtils.setIsEnable(true,teacher_iv,sharetime_ll,starttime_ll,endtime_ll,sharetitle_et,sharedesc_et)
                ViewUtils.setIsVisibility(View.VISIBLE,tv_save,sharetime_arrow,starttime_arrow,endtime_arrow)
                ViewUtils.setTextHint("设置",sharetitle_et,sharedesc_et)
