...
public class UserChoosePresenter extends BasePresenter implements UserChooseContract.Presenter {
    private final UserChooseContract.View mView;

    ServiceRepository repository;

    public UserChoosePresenter(UserChooseContract.View view,
                               ServiceRepository repository) {
        mView = view;
    ...
    @Override
    public void getUserList(int pageNo,String userName,String mobile) {
