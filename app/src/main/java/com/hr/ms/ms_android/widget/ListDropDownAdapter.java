...
public class ListDropDownAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.default_drop_down_item, null);
...
//                viewHolder.mText.setBackgroundResource(R.color.check_bg);
                ...
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.title_text));
