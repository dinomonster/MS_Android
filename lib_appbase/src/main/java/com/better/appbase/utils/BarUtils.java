...
public class BarUtils {
     ...
     */
    public static boolean FlymeSetStatusBarFontDark(Window window, boolean dark) {
    ...
    /**
     * 设置状态栏字体图标为深色，需要MIUIV6以上,MIUI9不适应
     *
     * @param window 需要设置的窗口
     * @param dark   是否把状态栏字体及图标颜色设置为深色
     * @return boolean 成功执行返回true
     */
    public static boolean MIUISetStatusBarFontDark(Window window, boolean dark) {
        boolean result = false;
        if (window != null) {
