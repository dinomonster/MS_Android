 ...
 * @date 2016-09-21
 */
public class BetterLoadingView extends BaseCustomView {
    ...
    public BetterLoadingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BetterLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public BetterLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    @Override
    public void initCustomView(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BetterLoadingView);
        mSize = typedArray.getDimensionPixelSize(R.styleable.BetterLoadingView_loading_width, getResources().getDimensionPixelSize(R.dimen.sx_dp18));
        mPaintColor = typedArray.getColor(R.styleable.BetterLoadingView_android_color, ContextCompat.getColor(context, R.color.color_353535));
        typedArray.recycle();
        initPaint();
    }
