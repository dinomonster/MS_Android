...
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mShapeMode = a.getInt(R.styleable.BaseCustomView_sx_image_mode, 0);
            mRadius = a.getDimension(R.styleable.BaseCustomView_sx_round_radius, 0);

            mStrokeWidth = a.getDimension(R.styleable.BaseCustomView_sx_border_width, 0);
            mStrokeColor = a.getColor(R.styleable.BaseCustomView_sx_border_color, mStrokeColor);
            a.recycle();
        }
