...
//https://github.com/chenBingX/SuperTextView/blob/master/README_zh.md
/*
app:pressBgColor    //按下的背景色
app:corner          //圆角半径
app:solid           //内部填充颜色
app:stroke_color    //边框颜色
app:stroke_width    //边框宽度
* */
...
public class SuperTextView extends AppCompatTextView {
     ...
     * @return SuperTextView
     */
    public SuperTextView setStrokeColor(@ColorInt int strokeColor) {
