...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.sx_sp10);
        mLargeTextSize = context.getResources().getDimensionPixelSize(R.dimen.sx_sp32);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.sx_dp20);
        if (attrs != null) {
            ...
            mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.sx_dp20));
            mBallRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.sx_dp20));
            a.recycle();
        }
