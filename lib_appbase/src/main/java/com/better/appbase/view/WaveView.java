...
public class WaveView extends View {
    ...
    private int mBottomWaveColor;   //底部颜色
    ...
    public void setWaveColor(int behindWaveColor, int frontWaveColor, int bottomWaveColor) {
        mBehindWaveColor = behindWaveColor;
        mFrontWaveColor = frontWaveColor;
        mBottomWaveColor = bottomWaveColor;
    ...
    private void createShader() {
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            ...
            if (mBottomWaveColor != 0) {
                Shader shader = new LinearGradient(beginX, beginY, beginX, endY, mBehindWaveColor, mBottomWaveColor, Shader.TileMode.CLAMP);
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            ...
            if (mBottomWaveColor != 0) {
                Shader shader = new LinearGradient(beginX, waveY[(beginX + wave2Shift) % endX], beginX, endY, mBehindWaveColor, mBottomWaveColor, Shader.TileMode.CLAMP);
                wavePaint.setShader(shader);
            }
