...
// 
//  ATTR	描述
//  tabIndicatorAlwaysInCenter	    如果设置为true，活动标签总是显示在中心,默认为false
...
//  tabIndicatorColor	            指示灯的宽度，默认为“自动”
//  tabIndicatorHorizontalPadding   指示灯的宽度padding填充
// 
//  topLineColor     	            顶线颜色
//  topLineHeight        	        顶线的厚度
...
//  tabTextColors         	        默认情况下包含的选项卡的文本颜色
//  tabTextSize          	        默认情况下包含的选项卡的文本大小
//  tabTextHorizontalPadding 	    默认情况下包含的选项卡的文本布局填充
...
public class BetterTabLayout extends HorizontalScrollView {
    ...
    protected final BetterTabStrip tabStrip;
    private int tabTitleOffset;
    private int tabBackground;
    private ColorStateList tabTextColors;
    private float tabTextSize;
    private int tabTextHorizontalPadding;
    ...
    public BetterTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BetterTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.BetterTabLayout_tabTextColors)) {
            tabTextColors = a.getColorStateList(R.styleable.BetterTabLayout_tabTextColors);
        }

        tabTextSize = a.getDimension(R.styleable.BetterTabLayout_tabTextSize, getResources().getDimensionPixelSize(R.dimen.sx_sp12));
        tabTextHorizontalPadding = a.getDimensionPixelSize(R.styleable.BetterTabLayout_tabTextHorizontalPadding, getResources().getDimensionPixelSize(R.dimen.sx_dp16));
        ...
        tabTitleOffset = a.getLayoutDimension(R.styleable.BetterTabLayout_tabTitleOffset, getResources().getDimensionPixelSize(R.dimen.sx_dp24));
        a.recycle();
        ...
        this.tabStrip = new BetterTabStrip(context, attrs);
    ...
    public void setIndicationInterpolator(BetterIndicationInterpolator interpolator) {
     ...
     */
    public void setDefaultTabTextColor(ColorStateList color) {
        tabTextColors = color;
    }
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link BetterTabLayout} you are
