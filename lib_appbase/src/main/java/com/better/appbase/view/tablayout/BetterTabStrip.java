...
class BetterTabStrip extends LinearLayout {
    ...
    private BetterIndicationInterpolator indicationInterpolator;
    private BetterTabLayout.TabColorizer customTabColorizer;

    BetterTabStrip(Context context, AttributeSet attrs) {
        super(context);
        ...
        tabIndicatorHeight = a.getDimensionPixelSize(R.styleable.BetterTabLayout_tabIndicatorHeight, getResources().getDimensionPixelSize(R.dimen.sx_dp2));
        ...
        this.indicationInterpolator = new BetterIndicationInterpolator();
    }
    ...
    void setIndicationInterpolator(BetterIndicationInterpolator interpolator) {
        indicationInterpolator = interpolator;
        invalidate();
    }

    void setCustomTabColorizer(BetterTabLayout.TabColorizer customTabColorizer) {
    ...
    BetterTabLayout.TabColorizer getTabColorizer() {
    ...
    private void drawDecoration(Canvas canvas) {
        ...
        final BetterTabLayout.TabColorizer tabColorizer = getTabColorizer();
    ...
    private static class SimpleTabColorizer implements BetterTabLayout.TabColorizer {
